...
import { BriefcaseBusiness, Navigation, Users } from "lucide-react";
...
const SpotLight = () => {
  return (
    <section className=" px-4 py-7 md:px-32">
      <div className="">
        <div className=" pt-5">
          <h2 className="text-4xl font-extrabold uppercase text-primaryColor">
            SpotLight
          </h2>
          ...
          <div className="flex-1">
            <div className="flex w-[100px] items-center justify-between py-4">
              <Separator
                ...
                className=" border border-secondaryColor h-6"
              />
              <div className="flex items-center">
                <BriefcaseBusiness className="mr-2  text-secondaryColor" />
                <p className="uppercase font-extrabold text-primaryColor text-sm">
                  Staff
                </p>
              </div>
            </div>
            <Card className="">
              ...
              <CardContent className="p-0">
                <p className="text-lg  text-white bg-primaryColor font-medium text-justify p-4">
                  ...
                  including textbooks, reference materials, journals, and
                  digital databases, all carefully curated to enhance learning
            ...
            <Card>
              <CardHeader className="p-0 ">
                <CardTitle>
                  <div>
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d126877.42316700633!2d-2.8079509735107306!3d6.404375633724914!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xfc4a77c27ac3389%3A0x82ab7ac63a6eae91!2sCOLLEGE%20OF%20HEALTH%2CSEFWI%20ASAFO!5e0!3m2!1sen!2sgh!4v1724862206004!5m2!1sen!2sgh"
                      allowFullScreen
                      loading="lazy"
                      className="w-full md:h-[308px]"
              ...
              <CardContent className="p-0 ">
                <p className="text-lg  text-white bg-primaryColor font-medium text-justify p-4 capitalize">
                  This nobel college of health is locate at Western North Region
                  of Ghana.
                </p>
              </CardContent>
            </Card>
