    ...
    return (
        <section className="  gap-10 md:flex md:px-32 py-4 px-4">
            <div className="md:mt-10 py-4 ">
                <h2 className="text-2xl md:text-4xl capitalize md:py-4 font-extrabold text-primaryColor pb-4">Welcome to College of Health at Sefwi-Asafo (COHSA)</h2>
                <div>
            ...
            <div className=" mt-8 md:gap-4 md:flex md:flex-col">
                <div className="md:flex md:gap-2">
                    <Card className="md:flex-1">
                        ...
                        <CardContent>
                            <h2 className="text-xl font-bold text-secondaryColor uppercase">COHSA Library</h2>
