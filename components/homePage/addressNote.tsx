  ...
  return (
    <section className="  gap-10 md:flex md:px-32 py-4 px-4">
      <div className="md:mt-10 py-4 ">
        <h2 className="text-2xl md:text-4xl capitalize md:py-4 font-extrabold text-primaryColor pb-4">
          Welcome to College of Health at Sefwi-Asafo (COHSA)
        </h2>
        <div>
          <p className="text-lg text-gray-900 md:mt-5 line-clamp-5 md:line-clamp-none text-justify ">
            {headMasterAddress}
          </p>
          <span>
      ...
      <div className=" mt-8 md:gap-4 md:flex md:flex-col">
        <div className="md:flex md:gap-2">
            ...
            <CardHeader className="bg-secondaryColor items-center">
              <CardTitle>
                <div className="w-16 h-16 p-4 items-center rounded-full bg-white">
                  <Library color="#e51719" size={30} />
                </div>
              </CardTitle>
            </CardHeader>
            <CardContent>
              <h2 className="text-xl font-bold text-secondaryColor uppercase">
                COHSA Library
              </h2>
          ...
          <Card className="md:flex-1">
            ...
            <CardContent>
              <h2 className="uppercase text-xl font-bold text-primaryColor">
