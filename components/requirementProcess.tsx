  ...
  return (
    <section>
      <div className="py-6 px-6">
        ...
        <p className="text-left text-sm font-bold text-gray-800">
          Before moving to the online application platform, applicants must have
          the following
        </p>
      </div>
      <div className="px-6">
        <Accordion type="single" collapsible className="">
          <AccordionItem value="item-1">
            <AccordionTrigger className="text-secondaryColor font-bold capitalize text-lg">
              Requirement to fill out the form
            </AccordionTrigger>
            <AccordionContent>
              <ul className="list-disc px-8 text-TeiColor font-medium text-xl text-left">
                <li className="pb-2"> Serial Number</li>
                <li className="pb-2">Pin</li>
                <li className="pb-2">WASSCE Certificate/Nov-Dec</li>
                <li className="pb-2">Active Phone Number</li>
                <li className="pb-2">
                  Passport Sized Photo
                  <div className="bg-secondaryColor text-white py-4 my-4 font-bold text-sm px-5 rounded-sm border-l-primaryColor border-l-8">
          ...
          <AccordionItem value="item-2">
            <AccordionTrigger className="text-secondaryColor font-bold capitalize text-lg">
              Information Required to fill out the form
            </AccordionTrigger>
            <AccordionContent>
              <ul className="list-disc px-8 text-TeiColor font-medium text-xl text-left">
