...
const ExamPage = () => {
  return (
    <section>
      ...
      <h2 className="absolute top-1/4 left-8  md:left-[28rem] md:top-1/3 text-white text-4xl md:text-6xl font-extrabold uppercase">
        cohsa exam rules
      </h2>
      <div className="mx-4 md:mx-32 bg-white relative -top-20">
        <div className="px-4 md:px-32 md:py-16 text-left tracking-wide font-medium text-xl text-TeiColor ">
          <p className="pb-4">
            Each course with the exception of a project work, shall normally be
            completed in one semester.
          </p>
          <p className="pb-4">
            A final (end-of-semester) examination shalll normally be required as
            a part of every course. An examination schedule for each course
            shall be published each semester.
          </p>
          <p className="pb-4">
            The marks obtained in the end-of-semester examination shall
            contribute 60% of the grade for the course while continues
            assessment contributes the remaining 40% (except for practical or
            other course which are assessed entirely by continuous assessment).
          </p>

          <Table>
            <TableCaption className="text-xl text-TeiColor font-bold text-left pb-4">
              Time allocated to examination papers
            </TableCaption>
          ...
          <h3>
            A candidate who fails to obtain a GPA of 1.50 in the first
            two-semester examination shall be asked by the head of the
            institution to withdraw from the institution. He/She may however
            resit the whole examination in the following year only.
          </h3>

          <div className="bg-secondaryColor text-white rounded-sm mt-7 mb-4 p-4 border border-l-8 border-l-primaryColor">
            <p className="text-lg">
              This rules have been agreed by Management and academic board that
              continuous assessment will not be considered for resit papers.
            </p>
          </div>
